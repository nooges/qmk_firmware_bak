 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------+------|
 * | Hyper| Ctrl | Alt  | GUI  |Lower |    Space    |Raise | Bksp |   \  | Left | Down |Right |
 * `------------------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {KC_HYPR, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_BSPC, KC_BSLS, KC_LEFT, KC_RGHT, KC_DOWN }
},
